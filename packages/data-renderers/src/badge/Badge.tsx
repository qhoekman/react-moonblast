...
const Counter = Styled<typeof Dot, ICounterProps>(Dot)(({ theme, color, bgColor }) => ({
  ...
  padding: bgColor === 'transparent' ? 0 : theme.padding[1],
  fontWeight: theme.fontWeights.medium,
  fontSize: bgColor === 'transparent' ? theme.fontSizes.md : theme.fontSizes.xs,
  color: theme.colors[color],
  backgroundColor: theme.colors[bgColor],
  boxShadow: bgColor === 'transparent' ? 'unset' : `0px 0px 1px ${theme.colors.white}`,
